...
export const CHALLENGES: Challenge[] = [
  ...
  {
    id: "week3_confused",
    mascotLabel: "Confused",
    mascotEmoji: "❓",
    mascotImage: "/mascots/confused.png",
    packImage: "/packs/confusedpack.png",
    targetPoints: 15_000,
    startDate: "2026-07-06",
    endDate: "2026-07-12",
    mode: "community",
    rewards: [
      { type: "mascot", cosmeticId: "mascot_confused", label: "Confused", emoji: "❓" },
      { type: "card_bg", cosmeticId: "bg_confused", label: "Confused BG", emoji: "🎴" },
      { type: "badge", cosmeticId: "badge_confused", label: "?! Badge", emoji: "?!" },
    ],
    fallbackReward: { type: "coins", amount: 150 },
  },
];
